...
const cp = exec(`D: && cd \\Steam\\steamapps\\common\\Blender && blender --verbose 4 Projects\\bugatti\\bugatti.blend --background --python Projects\\script1\\blender_script.py -- ${frame}`, (error, stdout, stderr) => {
    if (error) {
